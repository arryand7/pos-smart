...
## Corpus Check
- 295 files · ~99,558 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1645 nodes · 3486 edges · 221 communities (172 shown, 49 thin omitted)
...
## Communities (221 total, 49 thin omitted)
...
Cohesion: 0.06
Nodes (21): FinancialReportsExport, BalanceSheetSheet, CashFlowSheet, Carbon, ProfitLossSheet, TableExport, Carbon, ReportController (+13 more)
...
### Community 3 - "User"
Cohesion: 0.07
Nodes (9): BelongsTo, User, ProductCategoryPolicy, ProductPolicy, SantriPolicy, Illuminate\Database\Eloquent\Relations\HasOne, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable (+1 more)

### Community 4 - ".redirect"
Cohesion: 0.15
Nodes (4): LocationController, ProductController, RedirectResponse, SsoController

### Community 5 - "Controller"
Cohesion: 0.11
Nodes (8): Controller, DashboardController, GuardianCategoryController, GuardianPaymentController, GuardianSantriController, WalletTopupController, Illuminate\Foundation\Auth\Access\AuthorizesRequests, Illuminate\Routing\Controller

### Community 6 - "Transaction"
Cohesion: 0.08
Nodes (10): ReportController, LookupController, TransactionController, AnalyticsController, Carbon, Transaction, PosService, Illuminate\Database\Eloquent\Relations\MorphMany (+2 more)

### Community 7 - "ExportsTable.php"
Cohesion: 0.14
Nodes (5): ActivityLogController, SantriController, exportType(), ImageOptimizer, Illuminate\Http\UploadedFile

### Community 8 - "Illuminate\Database\Eloquent\Model"
Cohesion: 0.10
Nodes (6): DailyClosing, InventoryMovement, TransactionItem, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Database\Eloquent\Model, Illuminate\Database\Eloquent\Relations\BelongsTo
...
### Community 10 - "Santri"
Cohesion: 0.15
Nodes (5): Product, Santri, InventoryService, Illuminate\Database\Eloquent\SoftDeletes, CreatePosTransactionTest

### Community 12 - "Illuminate\View\View"
Cohesion: 0.19
Nodes (4): DashboardController, WalletManagementController, TransactionVerifyController, Illuminate\View\View

### Community 13 - "ProductCategory"
Cohesion: 0.19
Nodes (3): CategoryController, CatalogController, ProductCategory

### Community 14 - "Illuminate\Http\RedirectResponse"
Cohesion: 0.11
Nodes (8): AppSettingManager, AccountingSettingController, BrandingSettingController, EmailSettingController, SsoSettingController, MidtransRedirectController, AppSetting, Illuminate\Http\RedirectResponse
...
Cohesion: 0.15
Nodes (10): WalletTransaction, CreatesApplication, Illuminate\Foundation\Testing\RefreshDatabase, Illuminate\Foundation\Testing\TestCase, AuthLoginTest, PosWalletCommandsTest, GateUserReconciliationTest, PaymentWebhookControllerTest (+2 more)

### Community 18 - "PaymentService"
Cohesion: 0.15
Nodes (4): PaymentWebhookController, PaymentRedirectController, PaymentWebhookLog, PaymentService

### Community 20 - "WalletService"
Cohesion: 0.35
Nodes (3): WalletService, Carbon\CarbonImmutable, CarbonImmutable
...
Cohesion: 0.31
Nodes (3): AuditMoneyColumns, MoneyColumnAuditor, Illuminate\Console\Command

### Community 28 - "Payment.php"
Cohesion: 0.19
...
### Community 38 - "Rupiah"
Cohesion: 0.24
Nodes (4): PosWalletPreflight, ReconcileWallets, Rupiah, WalletLedgerReconciler
...
Cohesion: 0.18
Nodes (4): GateUserSyncController, ApplyGateUserSyncRequest, GateSyncBatch, Illuminate\Foundation\Http\FormRequest
...
### Community 167 - ".__invoke"
Cohesion: 0.38
Nodes (3): SantriPortalController, WaliPortalController, Illuminate\Contracts\View\View
...
### Community 178 - "Location"
Cohesion: 0.13
Nodes (3): Location, LocationPolicy, PosAccessTest

### Community 181 - "Illuminate\Http\Request"
Cohesion: 0.26
Nodes (3): UserController, ProfileController, Illuminate\Http\Request
...
### Community 218 - "keywords"
Cohesion: 0.67
Nodes (3): keywords, framework, laravel

## Knowledge Gaps
- **338 isolated node(s):** `$schema`, `name`, `type`, `description`, `laravel` (+333 more)
...
- **Why does `User` connect `User` to `Carbon\Carbon`, `.redirect`, `Controller`, `Transaction`, `Illuminate\Database\Eloquent\Model`, `Santri`, `UserRole.php`, `TestCase`, `Illuminate\Database\Eloquent\Relations\HasMany`, `ActivityLog`, `GateUserSyncService`, `EnsureSessionRole.php`, `Wali`, `SmartDemoSeeder`, `AuthBridgeController`, `WaliController`, `GateUserReconciliationService`, `ProductManagementTest`, `RuntimeException`, `Location`, `GateUserSyncTest`, `.handle`, `Illuminate\Http\Request`, `SantriPhotoTest`, `GateSyncBatch`, `AuthServiceProvider`, `PosConcurrencyTest`, `WalletController`, `WalletVisibilityTest`, `Transaction.php`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `Santri` connect `Santri` to `User`, `Controller`, `Transaction`, `ExportsTable.php`, `Illuminate\Database\Eloquent\Model`, `UserRole.php`, `Illuminate\View\View`, `TestCase`, `PaymentService`, `WalletService`, `Illuminate\Database\Eloquent\Relations\HasMany`, `ActivityLog`, `.url`, `Payment.php`, `GateUserSyncService`, `Wali`, `SmartDemoSeeder`, `Rupiah`, `.__invoke`, `Location`, `GateUserSyncTest`, `.handle`, `PosConcurrencyTest`, `SantriPhotoTest`, `WalletController`, `WalletVisibilityTest`, `Transaction.php`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `Payment` connect `Payment` to `JournalEntry`, `Illuminate\Database\Eloquent\Relations\MorphTo`, `User`, `Controller`, `Rupiah`, `DokuProvider`, `Illuminate\Database\Eloquent\Model`, `Wali`, `Santri`, `Illuminate\Http\RedirectResponse`, `TestCase`, `.config`, `PaymentService`, `MidtransProvider`, `ActivityLog`, `.url`, `Payment.php`, `IpaymuProvider`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Are the 35 inferred relationships involving `User` (e.g. with `.handle()` and `.index()`) actually correct?**
  _`User` has 35 INFERRED edges - model-reasoned connections that need verification._
- **Are the 36 inferred relationships involving `Santri` (e.g. with `.handle()` and `.handle()`) actually correct?**
  _`Santri` has 36 INFERRED edges - model-reasoned connections that need verification._
